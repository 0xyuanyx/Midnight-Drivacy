...
The web target is a fast preview of the same React Native application, not a separate product web app. It adds an iPhone-style frame only on web so review screenshots are easier to read; iOS and Android builds do not include that frame.
