...
Verification on 2026-09-22: 47 mobile Jest tests, including hydrated consent/policy deep-route protection, exactly-once authorized simulated-trip processing, the Documents tab route, and policy identifying metadata; mobile typecheck/lint, Expo Doctor (21/21), and Expo web/iOS/Android export passed. The web flow was manually checked at 402×874 and 360×740 with consent, insurance, two drives, review, pending demo approval, and result. The updated pill navigation and policy-card selected state were additionally checked at 402×874. This is browser QA only; physical iOS/Android devices and Expo Go have not been exercised.
